<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.master" AutoEventWireup="true" CodeFile="user_dashboard.aspx.cs" Inherits="user_dashboard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="container-fluid">
        <h2 class="text-light animate__animated animate__slideInRight">Book Your Events</h2><br />
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <a href="payment.aspx?ename=<%# Eval("id") %>" class="btn btn-outline-light">Book Now</a>
                            </div>
                        </div>
                    </div>
                </div>
